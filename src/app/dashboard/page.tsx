...
export default async function DashboardPage() {
  ...
  // Buscar dados do usuário para verificar plano e buscas
  ...
  const buscasRestantes = userData?.buscas_restantes || 5;
  const plano = userData?.plano || 'gratuito';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold capitalize">{plano}</div>
              <p className="text-xs text-muted-foreground">
                {plano === 'gratuito' ? '5 buscas grátis' : 'Buscas ilimitadas'}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {buscasRestantes === -1 ? '∞' : buscasRestantes}
              </div>
              <p className="text-xs text-muted-foreground">
                {buscasRestantes === -1 ? 'Ilimitadas' : 'Restantes este mês'}
              </p>
            </CardContent>
          </Card>
        </div>
